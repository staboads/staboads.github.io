          ...
          <ul>
            <li>
              <a href="https://twitter.com/EmeraldGroup"
                ><img
                  id="X"
                  src="images/Social Media Logos/twitterx.png"
                  alt="twitter link"
              /></a>
            </li>
            <li>
              <a href="https://instagram.com/EmeraldGroup"
                ><img
                  id="Instagram"
                  src="images/Social Media Logos/insta.png"
                  alt="instagram link"
              /></a>
            </li>
            <li>
              <a href="https://facebook.com/EmeraldGroup"
                ><img
                  id="Facebook"
                  src="images/Social Media Logos/facebook.png"
                  alt="facebook link"
              /></a>
            </li>
            <li>
            ...
            <li>
              <a href="https://tiktok.com/EmeraldGroup"
                ><img
                  id="TikTok"
                  src="images/Social Media Logos/tiktok.png"
                  alt="TikTok link"
              /></a>
            </li>
            <li>
              <a href="https://linkedin.com/EmeraldGroup"
                ><img
                  id="LinkedIn"
                  src="images/Social Media Logos/linkedin.png"
                  alt="LinkedIn link"
              /></a>
            </li>
          </ul>
